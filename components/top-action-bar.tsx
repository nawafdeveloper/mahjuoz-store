...
export default function TopActionBar({
    ...
    return (
        <div className='flex flex-row items-center justify-between w-full md:max-w-5xl md:mx-auto p-4'>
            <button onClick={() => onSelectChange(locale === 'ar' ? 'en' : 'ar')} className='p-2 rounded-full items-center justify-center flex bg-gray-100 cursor-pointer'>
            ...
            <div className='flex flex-row items-center gap-x-2'>
                {twitter && (
                    <Link
                        ...
                        href={twitter}
                        className='p-2 rounded-full items-center justify-center flex bg-gray-100 cursor-pointer'>
