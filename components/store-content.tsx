                    ...
                    {layout === 'grid' ? (
                            ...
                            {services.map((item) => (
                                <div key={item.id}>
                                    {item.services.map((item) => (
                                        <Link key={item.id} href={`http://${store.webIdentifier}.mahjuoz.com/${locale}/service/${item.id}`} className='flex flex-col space-y-2 overflow-hidden rounded-md'>
                                            <Image
                                                src={item.images[0]}
                        ...
                        <div className='flex flex-col space-y-3'>
                            {services.map((item) => (
                                <div key={item.id}>
                                    {item.services.map((item) => (
                                        <Link key={item.id} href={`http://${store.webIdentifier}.mahjuoz.com/${locale}/service/${item.id}`} className='flex flex-row gap-x-3 p-3 rounded-md bg-gray-50'>
                                            <Image
                                                src={item.images[0]}
                                                alt={`${item.titleEn} - Image`}
                                                width={500}
